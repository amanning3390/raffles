...
echo "🎯 Raffle App - Post-Deployment Setup"
echo "======================================"
echo ""
...
if [[ ! $CONTRACT_ADDRESS =~ ^0x[a-fA-F0-9]{40}$ ]]; then
    echo "❌ Invalid contract address format. Should be 0x followed by 40 hex characters."
    exit 1
fi

# Prompt for network
echo ""
echo "🌐 Which network did you deploy to?"
