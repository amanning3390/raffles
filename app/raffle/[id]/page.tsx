...
export default function RaffleDetailPage({ params }: { params: { id: string } }) {
  ...
  if (isLoadingRaffle) {
    return (
      <>
        <Navbar />
        <main className="min-h-screen pt-28 px-4 pb-16 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-blue-950/20">
    ...
    <>
      ...
      <main className="min-h-screen pt-28 px-4 pb-16 animate-fade-in bg-gradient-to-br from-gray-50 via-white to-blue-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-blue-950/20">
        <div className="max-w-7xl mx-auto">
          ...
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all duration-200 mb-8 group"
          >
